...
export const skillUISchema = z.object({
  ...
  options: z
    .array(skillOptionSchema)
    .optional()
    .describe("Available options for selection (for question/variants types)"),
  skill: skillDataSchema
    .optional()
    .describe("Complete skill definition (for final-skill type)"),
  type: z
    .enum(["question", "variants", "final-skill", "clarification"])

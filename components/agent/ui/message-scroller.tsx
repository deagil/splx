...
import { chatScrollerContentClass } from "@/components/agent/chat-layout";
...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      className={cn(
        "scrollbar-thin scrollbar-gutter-stable data-autoscrolling:scrollbar-thumb-transparent data-autoscrolling:scrollbar-track-transparent size-full min-h-0 min-w-0 overflow-y-auto overscroll-contain contain-content",
        className
      )}

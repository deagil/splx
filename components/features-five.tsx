          ...
          <div className="grid gap-12 md:grid-cols-5">
            <div className="md:col-span-2">
              <h2 className="text-balance font-semibold text-4xl text-foreground">
                An AI-native builder that keeps your launch moving
              </h2>
            ...
            <div className="space-y-6 md:col-span-3 md:space-y-10">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-foreground text-lg">
                    AI that drafts the page, you keep control
                  </h3>
                </div>
                <p className="mt-3 text-balance text-muted-foreground">
                  Describe the outcome and Suplex sketches the layout with the
                  right data hooks. You decide what ships, with no template
                  lock-in.
                </p>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-foreground text-lg">
                    Data-aware content that stays accurate
                  </h3>
                </div>
                <p className="mt-3 text-balance text-muted-foreground">
                  Use data mentions to pull live values, roll out updates once,
                  and keep every page in sync without manual edits.
                </p>
              </div>
            </div>
          </div>
